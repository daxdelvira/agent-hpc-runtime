...
#SBATCH --mem=320G
#SBATCH -t 01:00:00
#SBATCH -o v0_park_column_%j.log
#SBATCH -e v0_park_column_%j.log
#
...
python3 experiments/bench_h1_quantized_park.py \
    --model-path "$MODEL" \
    --gpus 0 --tp 1 --port 8244 \
    --arms fp16 \
    --out "results/bench_v0_park_column_${SLURM_JOB_ID}.json"
rc=$?
