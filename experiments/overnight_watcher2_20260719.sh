...
cd "$REPO"
WLOG=$REPO/logs/overnight_watcher2_20260719.log
mkdir -p "$REPO/logs"

# ---- assignments -----------------------------------------------------------
L40S_JOBS="11267689 11267690 11267691 11267692"
BW_JOBS="11267675 11267676 11267677 11267678"
L40S_SCRIPT="run_eval_l40s_screen_20260719.sh"
L40S_SECONDARY=""
BW_SCRIPT="run_eval_bw_screen_20260719.sh"
