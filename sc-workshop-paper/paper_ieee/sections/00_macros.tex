...
%
% \abovecaptionskip -- the gap between a graphic and its own caption -- is cut
% only to 0.8. It is the one skip where shrinking crowds rather than tightens,
% so it is the last to be touched and is not taken as far as the others.
...
\setlength{\abovecaptionskip}{0.8\abovecaptionskip}
