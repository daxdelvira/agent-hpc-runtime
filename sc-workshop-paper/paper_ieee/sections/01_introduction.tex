...
further 10.3--17.1\%. We attribute the result to each mechanism separately and
report where each stops working---retention cannot help a first use, staging
cannot help without a window, and above roughly 86\% of the total footprint
neither is needed.
