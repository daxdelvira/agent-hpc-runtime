...
%
% THIS IS THE KNOB. If it still lands in column 1, move this block one
% paragraph later; if it slips to page 2, move it one paragraph earlier. The
% right point shifts when the abstract is written, since the abstract is what
% consumes the top of column 1 -- re-check after writing it.
\begin{figure}[tb]
\centering
