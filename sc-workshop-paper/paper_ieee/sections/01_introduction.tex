...
fails for agentic ones. The data need is known before the phase begins in one
case and only after a steering decision in the other, leaving too little
window to hide the transfer.}
