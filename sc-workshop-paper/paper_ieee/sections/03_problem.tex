...
\caption{AtomAgents plan compliance per planned step, over 64 runs. Scored
on order alone (top) the plan holds; scored positionally, with a retry
consuming a plan slot (bottom), everything after the first divergence misses.}
