...
\caption{Share of decisions in which memory pressure forced an eviction, by
budget and accelerator capacity. Above roughly 86\% of the total footprint
nothing is ever evicted and the arbitration problem disappears; below it,
budget admits resources in steps rather than smoothly.}
