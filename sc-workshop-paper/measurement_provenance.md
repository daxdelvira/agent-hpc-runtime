...
| D10b | flat across **212×** of real data (0.29 GB Swiss-Prot → 60.95 GB UniRef90, 121.4 M records): expansion 1.92–2.13×, s/GB 2.97–3.35, share 47.1–48.6% | same | `results/bench_p1_real_uniref90_full.json` + the UniRef50 set | **A** — UniRef90 is a *different* database (90% vs 50% identity), so this is not just a bigger sample |
